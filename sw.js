...
const CACHE = "giorenatto-v3"; // v3: las fotos se recomprimieron in-place (mismo nombre/ruta) — subir la versión fuerza a los celus que ya tienen la app a bajar las nuevas

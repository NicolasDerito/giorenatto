...
const CACHE = "giorenatto-v4"; // v4: Etapa 2 de conversión (ficha, carrito y checkout) — subir la versión fuerza a los celus que ya tienen la app a bajar la nueva

...
const CACHE = "giorenatto-v6"; // v6: rediseño Etapa 3 (Propuesta A) — cambia index.html y nosotros.html (papel, arco, destacados numerados) y sw.js; subir la versión fuerza a los celus que ya tienen la app a bajar el HTML/CSS nuevo en vez de la copia vieja de caché

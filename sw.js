...
const CACHE = "giorenatto-v8"; // v8: carrito en celular (el resumen aplastaba la lista de productos) y renglón de cada prenda más claro; subir la versión fuerza a los celus a bajar el HTML/CSS nuevo
